...
class Administration(models.Model):
    ...
    option1 = models.CharField(max_length=100,null=True,default=None)
    ...
    option2 = models.CharField(max_length=100,null=True,default=None)
    ...
    option3 = models.CharField(max_length=100,null=True,default=None)
